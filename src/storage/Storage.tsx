...
// 브라우저 storage
// - 변수등을 사용하여 프로그램에서 메모리로 데이터를 관리하는 것이 아니라 브라우저 저장공간에서 관리하는 방법(반영구적)
...
//   - session storage : 현재 세션이 유지(브라우저가 켜져있는 동안)되는 동안 영구적으로 유지됨
//   - indexDB : 브라우저를 받아도 영구적으로 유지됨 (많은 데이터를 저장하고자 할 때 사용, JSON 형태)
...
export default function Storage() {
  ...
  return (
    <div>
      ...
      <button onClick={onSessionStorageSave}>세션 스토리지 저장</button>
    </div>
  );
}
